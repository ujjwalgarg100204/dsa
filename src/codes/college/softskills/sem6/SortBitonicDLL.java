...
public class SortBitonicDLL {
  ...
  /**
   * This approach finds the pivot point of the linked list and reverses the second half (decreasing
   * order). It then merges both the linekd list and returns the head after merging. Time: O(n)
   * Space: O(1)
   */
