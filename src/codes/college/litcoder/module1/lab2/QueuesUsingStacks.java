package codes.college.litcoder.module1.lab2;
...
class Queue {
    ...
    private final Deque<Integer> tempStack;
    ...
    /**
     * Removes and returns the element at the front of the queue. This operation has a time complexity
     * of O(n), where n is the number of elements in the queue.
     */
    public void dequeue() {
