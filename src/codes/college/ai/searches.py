...
def breadth_first_search(
    ...
    """
    Perform Breadth-First Search (codes.striveratozdsasheet._015graphs._01learning.BFS) on a graph to find a path from
...
def depth_first_search_recursive(
    ...
    """
    Perform Depth-First Search (codes.striveratozdsasheet._015graphs._01learning.DFS) recursively on a graph to find a path from
    a start vertex to a goal vertex.
...
def _depth_first_search_recursive_util(
    ...
    """
    Utility function for performing Depth-First Search (codes.striveratozdsasheet._015graphs._01learning.DFS) recursively on a graph.
...
def depth_first_search_iterative(
    ...
    """
    Perform Depth-First Search (codes.striveratozdsasheet._015graphs._01learning.DFS) iteratively on a graph to find a path from
    a start vertex to a goal vertex.
...
def best_first_search(
    ...
    """
    Perform Best-First Search (codes.striveratozdsasheet._015graphs._01learning.BFS) on a graph to find a path from
